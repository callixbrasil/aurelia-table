...
System.register(['aurelia-framework'], function (_export, _context) {
  ...
  var observable, _createClass, _desc, _value, _class, _descriptor, _descriptor2, TableSettings, TableResult;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('TableSettings', TableSettings = (_class = function () {
      ...
      _export('TableResult', TableResult = function TableResult(result) {
